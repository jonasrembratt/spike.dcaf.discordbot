...
namespace DCAF.Google
{
    ...
    public static class GoogleSheetHelper
    {
        ...
        public static Outcome WithGoogleApiError(this Outcome outcome, object error)
        {
            return outcome.WithValue(KeyGoogleApiError, error);
        }

        public static bool TryGetGoogleApiError(this Outcome outcome, out object? error)
        {
